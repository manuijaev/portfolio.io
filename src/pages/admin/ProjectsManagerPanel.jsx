...
export default function ProjectsManagerPanel() {
  ...
  return (
    ...
    >
      <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-4">Projects Manager</h2>
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="space-y-3">
          ...
          {(projectSaveState.isSaving || projectSaveState.progress > 0) && (
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-3 dark:border-emerald-800/70 dark:bg-emerald-950/40">
